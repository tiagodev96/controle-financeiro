...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      account_transfers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "account_transfers_household_id_fkey"
            columns: ["household_id"]
            isOneToOne: false
            referencedRelation: "households"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "account_transfers_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_transfers_source_transaction_id_fkey"
    ...
    Functions: {
      apply_coverage_transfers: {
        Args: { p_occurred_on: string; p_transfers: Json; p_txn_id: string }
        Returns: undefined
      }
      ...
      mark_paid_with_coverage: {
        Args: { p_paid_on: string; p_transaction_id: string; p_transfers: Json }
        Returns: undefined
      }
      reverse_payment: {
